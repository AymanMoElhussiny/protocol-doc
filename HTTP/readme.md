...
An HTTP is an application layer protocol that comes above the [TCP layer](TCP). It has provided some standard rules to the web browsers and servers, which they can use to communicate with each other.
